...
const UserRight = ({ tabContentList, data }) => {
  ...
  // States
  const [activeTab, setActiveTab] = useState(lastSegment === 'security' ? 'security' : 'overview')
        ...
        <Grid container spacing={6}>
          <Grid size={{ xs: 12 }}>
            <CustomTabList onChange={handleChange} variant='scrollable' pill='true'>
              ...
              <Tab icon={<i className='ri-lock-line' />} value='commission' label='Commission' iconPosition='start' />
            </CustomTabList>
          </Grid>
          <Grid size={{ xs: 12 }}>

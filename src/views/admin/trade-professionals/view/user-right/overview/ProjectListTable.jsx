...
import { fetchById } from '@/app/[lang]/(dashboard)/(private)/trade-professional/profile/[[...page]]/page'
        ...
        cell: ({ row }) => {
          ...
          const handleDownload = () => {
            try {
              ...
              linkElement.style.display = 'none' // Avoid flashing
              ...
              if (document.body) {
                ...
                // Remove the link after a short delay, only if it is still a child
                setTimeout(() => {

...
const RetailCustomersList = ({ fetchList, deleteRecord, updateStatus }) => {
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            <IconButton onClick={() => router.push(`/admin/retail-customers/view/${row.original._id}`)}>
...
export default RetailCustomersList;

...
const ClientListTable = () => {
  ...
  const columns = useMemo(
    () => [
      columnHelper.accessor('subject', {
        ...
        cell: ({ row }) => (
          <div
            onClick={() => router.push(getLocalizedUrl(`/admin/support-tickets/view/${row.original.id}`, locale))}
          ...
          <div className='flex items-center'>
            <IconButton onClick={() => handleEdit(row)}>
              <OpenDialogOnElementClick
                ...
                dialogProps={{ data: editData, setRefresh: setRefresh }}
              />
            </IconButton>
  ...
  const handleEdit = data => {
    setEditData(data)
    // ✅ Ensure this is not called before OpenDialogOnElementClick is rendered
    setTimeout(() => {
  ...
  const EditIcon = () =>{
    return  <i className='ri-edit-line' />
  }
  return (

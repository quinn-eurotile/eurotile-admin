...
const ProductFeaturedImage = () => {
  ...
  const featuredImage = watch('featuredImage') || null
  ...
  const { getRootProps, getInputProps } = useDropzone({
    ...
    onDrop: acceptedFiles => {
      if (acceptedFiles.length > 0) {
        ...
        setValue('featuredImage', file, { shouldValidate: true, shouldDirty: true })
      }
    }
  })

  const handleRemoveFile = () => {
    setValue('featuredImage', null, { shouldValidate: true, shouldDirty: true })
  }
